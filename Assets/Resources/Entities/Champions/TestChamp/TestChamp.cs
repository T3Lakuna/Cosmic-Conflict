	...
	private new void Start() {
		...
		this.SetupChampion(30, 5, 30, 5, 550, 15, 3, 0.5, 300, 20, 3, 0.5, 20, 3, 20, 3, 0, 0, 0, 0, 0, 0, 0.75, 0, 10, 1, 0, 0, 0, 0, 0, 1, 30, 0, 5, this.GetComponent<Animator>(), "TestChamp", Resources.Load<Sprite>("Entities/Champions/TestChamp/Icon"),
			...
			new Ability(3, this, "TestSecondary", "Test.", 100, UnityEngine.Resources.Load<Sprite>("Entities/Champions/TestChamp/SecondaryIcon"), () => {
				...
				abilityObject.collisionAction = () => { Ability.DealDamage(false, this, abilityObject.collidedEntity, Ability.DamageType.True, this.damage.CurrentValue * 0.5, 0); };
			}),
			...
			new Ability(0, this, "TestUltimate", "Test.", 50, UnityEngine.Resources.Load<Sprite>("Entities/Champions/TestChamp/UltimateIcon"), () => {
				...
				AbilityObject abilityObject = Ability.CreateAbilityObject("Entities/Champions/TestChamp/TertiaryModel", false, true, false, true, this, this.transform.position, targetEntity.transform.position, targetEntity, 10, 10, 10);
				Ability aoeAbility = new Ability(0, this, "TestUltimate AoE", "Test.", 0, null, () => { });
				aoeAbility.Action = () => { Ability.DealDamage(false, this, aoeAbility.target, Ability.DamageType.Magical, 0, 15); };
