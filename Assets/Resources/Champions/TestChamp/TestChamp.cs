...
public class TestChamp : Champion {
	private new void Start() {
		...
		this.SetupChampion(30, 5, 30, 5, 550, 15, 3, 0.5, 300, 20, 3, 0.5, 20, 3, 20, 3, 0, 0, 0, 0, 0, 0, 0.75, 0, 10, 1, 0, 0, 0, 0, 0, 1, 30, 0, "TestChamp", Resources.Load<Sprite>("Champions/TestChamp/Icon"),
			new Ability(0, this, "TestPassive", "Test.", 0, UnityEngine.Resources.Load<Sprite>("Champions/TestChamp/PassiveIcon"), () => {
			...
			new Ability(0, this, "TestPrimary", "Test.", 0, UnityEngine.Resources.Load<Sprite>("Champions/TestChamp/PrimaryIcon"), () => {
				// Can be used with passive to test leveling up, or to test items.

				this.currency += 1000;
			}),
			new Ability(3, this, "TestSecondary", "Test.", 100, UnityEngine.Resources.Load<Sprite>("Champions/TestChamp/SecondaryIcon"), () => {
			...
			new Ability(0, this, "TestTertiary", "Test.", 50, UnityEngine.Resources.Load<Sprite>("Champions/TestChamp/TertiaryIcon"), () => {
			...
			new Ability(0, this, "TestUltimate", "Test.", 50, UnityEngine.Resources.Load<Sprite>("Champions/TestChamp/UltimateIcon"), () => {
