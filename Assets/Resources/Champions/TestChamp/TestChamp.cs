...
public class TestChamp : Champion {
	private new void Start() {
		...
		this.SetupChampion(30, 5, 30, 5, 550, 15, 3, 0.5, 300, 20, 3, 0.5, 20, 3, 20, 3, 0, 0, 0, 0, 0, 0, 3, 0, 10, 1, 0, 0, 0, 0, 0, 0, 500, 0, "TestChamp",
			...
			new Ability(3, this, null, "TestSecondary", "Test.", 100, UnityEngine.Resources.Load<Sprite>("Champions/TestChamp/SecondaryAbilityIcon"), () => {
				...
				abilityObject.collisionAction = () => { Ability.DealDamage(abilityObject.collidedEntity, Ability.DamageType.True, 10, 0); };
			}),
